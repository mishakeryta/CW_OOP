...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pbReadFromFile->setGeometry(QRect(170, 200, 97, 21));
        twMilitaries = new QTableWidget(centralWidget);
        twMilitaries->setObjectName(QStringLiteral("twMilitaries"));
        twMilitaries->setGeometry(QRect(30, 41, 301, 151));
        lBattlionName = new QLabel(centralWidget);
        lBattlionName->setObjectName(QStringLiteral("lBattlionName"));
        lBattlionName->setGeometry(QRect(50, 10, 71, 23));
